...
- [ ] 210-01-PLAN.md — resolveTabLens pure helper + unit tests, and per-tab lens memory (state + tab-entry effect + explicit-pick interception) in Results.jsx
...
| 210. Per-Tab Compass Integration | 0/2 | Planned | - |
