...
| 144 | Glendale deep-seed | 4/4 | Complete   | 2026-06-20 |
...
- [x] 143-03-PLAN.md — Headshots for McLean + Miranda (600×750) + full-roster image audit — migration 896 (audit-only)
...
- [x] 144-03-PLAN.md — Headshots: source Brotman + re-source Gharpetian off scraped_no_license (browser, WAF-blocked), audit Kassakhian/Asatryan, document Bartrosouf gap (audit-only 904)
- [x] 144-04-PLAN.md — Stances: evidence-only compass coverage for the 5 going-forward members, chairs model, no judicial topics, Armenian/Artsakh as EXTRA (audit-only 905-909)
