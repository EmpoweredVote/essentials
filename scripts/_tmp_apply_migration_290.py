#!/usr/bin/env python3
"""Apply migration 290 in per-delegate chunks to avoid WAF blocking.
Uses file-based psql -f approach for Unicode safety."""
import re
import subprocess
import sys
import os
...
MIGRATION_PATH = r"C:/EV-Accounts/backend/migrations/290_md_delegates_batch_e.sql"
