...
- [x] 154-04-PLAN.md — Wave 3 stances: evidence-only CHAIRS greenfield for all 5 (Anthony to Rizzotti), 100% cited, no judicial (migs 1029-1033, audit-only; blocking checkpoint)
...
- [x] 155-04-PLAN.md — Wave 4 stances: evidence-only CHAIRS for 5 officials, shelter-ban anchor, 100% cited (blocking human-verify)
