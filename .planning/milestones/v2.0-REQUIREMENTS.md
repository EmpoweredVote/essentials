# Requirements Archive: v2.0 Elections Page
...
**Adjusted:**
- ELEC-02: Original plan used city+state geocoding for Connected auto-load; switched to `elections/me` endpoint after discovering Census Geocoder fails with city+state input and returns wrong-district races for users whose stored location doesn't resolve to a clean street address.

**Dropped:** None

---
*Archived: 2026-04-13 as part of v2.0 milestone completion*
