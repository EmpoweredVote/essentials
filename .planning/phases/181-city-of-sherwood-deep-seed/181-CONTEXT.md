...
- **D-14: Banner subject priority hint — Old Town Sherwood street-level scene** (the historic Smockville-era main street / Cannery Square area), per the 180 lesson: **banners must show the RECOGNIZABLE EVERYDAY street view a resident knows — NOT architectural landmarks cropped to rooflines, NOT aerials.** Browse the Wikimedia **Category:Sherwood, Oregon** gallery and present ground-level street-scene candidates to the operator FIRST (in 180 the operator picked from exactly that gallery after rejecting a landmark and an aerial). As always, a clean license + crops-well-to-1700×540 beats subject preference.
...
- Banner: recognizable everyday Old Town Sherwood street view — the operator explicitly rejected a landmark roofline and an aerial in 180; present street-level Wikimedia category candidates first.
