...
- [x] **COLLIN-CONTACT-03**: `valid_to` / term-end dates are populated for seated officials where the term is publicly known (data-quality follow-up from earlier phases).
