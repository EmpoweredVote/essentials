...
- **D-04:** No milestone gate — 212 ships with House guaranteed nationwide and county best-effort. (User: "do all the congress, and wait for county.") *(Scoping decision realized by plan 212-05's national-fallback floor: House guaranteed via D-01/D-02 wiring, county best-effort via D-03.)*
